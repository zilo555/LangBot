...
const zhHans = {
  ...
  agents: {
    ...
    noRunnerMetadata: '当前没有可用的运行器元数据。',
    ...
    noRunnersAvailableDescription: '请先安装并启用运行器扩展，再配置此 Agent。',
    installedRunners: '已安装的运行器',
    marketplaceRunners: '插件市场中的运行器插件',
    viewMarketplace: '查看市场',
    restoringRunnerInstall: '正在恢复运行器插件安装并等待运行器就绪…',
    noInstalledRunners: '尚未安装任何运行器扩展。',
  ...
  pipelines: {
    ...
    runner: {
      toolsTitle: '工具',
      toolsDescription: '选择当前运行器可以调用的插件、MCP、技能和内置工具。',
      toolsScopeTooltip:
      ...
      selectTools: '选择工具',
      resourcesTitle: '资源',
      resourcesDescription: '选择当前运行器可以读取的 MCP 资源和知识库。',
      knowledgeBases: '知识库',
      mcpResources: 'MCP 资源',
